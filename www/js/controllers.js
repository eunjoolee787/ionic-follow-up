...
.controller('LoginCtrl', function($scope, $ionicPopup, $state, $http) {
    ...
    $scope.login = function() {
      $http.post("http://eunjoolee.com/validateUser", {username: $scope.data.username, password: $scope.data.password})
...
.controller('DashCtrl', function($http, $scope) {
  ...
  app.people = [];
    ...
    app.addPerson = function (person) {
      console.log(person);
      $http.post("http://eunjoolee.com/form", person)
        .success(function (data) {
          app.people = data;
          console.log(data);
        })
...
.controller('ProspectsEditCtrl', function($scope, $stateParams, Prospects, $http) {
 var app = this;
  ...
  app.editPerson = function (person) {
      $http.put("http://eunjoolee.com/prospects/"+$stateParams.prospectId, person)
        .success(function (data) {
          app.person = data;
          console.log(data);
        })
